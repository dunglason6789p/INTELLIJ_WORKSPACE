...
class ControlPanel extends JPanel {
   ...
   static {
      LOG = Logger.getLogger(class$org$apache$log4j$chainsaw$ControlPanel == null ? (class$org$apache$log4j$chainsaw$ControlPanel = class$("org.apache.log4j.chainsaw.ControlPanel")) : class$org$apache$log4j$chainsaw$ControlPanel);
   }
}
