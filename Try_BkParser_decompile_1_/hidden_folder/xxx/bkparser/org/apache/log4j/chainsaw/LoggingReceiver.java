...
class LoggingReceiver extends Thread {
   ...
   static {
      LOG = Logger.getLogger(class$org$apache$log4j$chainsaw$LoggingReceiver == null ? (class$org$apache$log4j$chainsaw$LoggingReceiver = class$("org.apache.log4j.chainsaw.LoggingReceiver")) : class$org$apache$log4j$chainsaw$LoggingReceiver);
   }
