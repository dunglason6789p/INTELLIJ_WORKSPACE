...
public class Main extends JFrame {
   ...
   static {
      LOG = Logger.getLogger(class$org$apache$log4j$chainsaw$Main == null ? (class$org$apache$log4j$chainsaw$Main = class$("org.apache.log4j.chainsaw.Main")) : class$org$apache$log4j$chainsaw$Main);
   }
}
