...
class DetailPanel extends JPanel implements ListSelectionListener {
   ...
   static {
      LOG = Logger.getLogger(class$org$apache$log4j$chainsaw$DetailPanel == null ? (class$org$apache$log4j$chainsaw$DetailPanel = class$("org.apache.log4j.chainsaw.DetailPanel")) : class$org$apache$log4j$chainsaw$DetailPanel);
