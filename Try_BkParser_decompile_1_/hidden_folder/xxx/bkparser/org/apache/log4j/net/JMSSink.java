...
public class JMSSink implements MessageListener {
   ...
   static void usage(String msg) {
      ...
      System.err.println("Usage: java " + (class$org$apache$log4j$net$JMSSink == null ? (class$org$apache$log4j$net$JMSSink = class$("org.apache.log4j.net.JMSSink")) : class$org$apache$log4j$net$JMSSink).getName() + " TopicConnectionFactoryBindingName TopicBindingName username password configFile");
      System.exit(1);
   }

   static {
      logger = Logger.getLogger(class$org$apache$log4j$net$JMSSink == null ? (class$org$apache$log4j$net$JMSSink = class$("org.apache.log4j.net.JMSSink")) : class$org$apache$log4j$net$JMSSink);
   }
}
