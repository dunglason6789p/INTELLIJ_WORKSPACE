...
public class SMTPAppender extends AppenderSkeleton implements UnrecognizedElementHandler {
   ...
   InternetAddress getAddress(String addressStr) {
      try {
         ...
         super.errorHandler.error("Could not parse address [" + addressStr + "].", var3, 6);
         return null;
      }
   }
   ...
   protected void sendBuffer() {
      try {
         ...
         if (allAscii) {
            ...
            part.setContent(s, super.layout.getContentType());
         } else {
            try {
               ...
               headers.setHeader("Content-Type", super.layout.getContentType() + "; charset=UTF-8");
               ...
               part = new MimeBodyPart();
               part.setContent(sbuf.toString(), super.layout.getContentType());
            }
         }
   ...
   public void setEvaluatorClass(String value) {
      this.evaluator = (TriggeringEventEvaluator)OptionConverter.instantiateByClassName(value, class$org$apache$log4j$spi$TriggeringEventEvaluator == null ? (class$org$apache$log4j$spi$TriggeringEventEvaluator = class$("org.apache.log4j.spi.TriggeringEventEvaluator")) : class$org$apache$log4j$spi$TriggeringEventEvaluator, this.evaluator);
   }
   ...
   public boolean parseUnrecognizedElement(Element element, Properties props) throws Exception {
      if ("triggeringPolicy".equals(element.getNodeName())) {
         Object triggerPolicy = DOMConfigurator.parseElement(element, props, class$org$apache$log4j$spi$TriggeringEventEvaluator == null ? (class$org$apache$log4j$spi$TriggeringEventEvaluator = class$("org.apache.log4j.spi.TriggeringEventEvaluator")) : class$org$apache$log4j$spi$TriggeringEventEvaluator);
