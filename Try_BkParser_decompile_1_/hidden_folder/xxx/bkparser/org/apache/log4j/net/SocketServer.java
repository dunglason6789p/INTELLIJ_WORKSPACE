...
public class SocketServer {
   ...
   static void usage(String msg) {
      ...
      System.err.println("Usage: java " + (class$org$apache$log4j$net$SocketServer == null ? (class$org$apache$log4j$net$SocketServer = class$("org.apache.log4j.net.SocketServer")) : class$org$apache$log4j$net$SocketServer).getName() + " port configFile directory");
      System.exit(1);
   }
   ...
   static {
      cat = Logger.getLogger(class$org$apache$log4j$net$SocketServer == null ? (class$org$apache$log4j$net$SocketServer = class$("org.apache.log4j.net.SocketServer")) : class$org$apache$log4j$net$SocketServer);
   }
}
