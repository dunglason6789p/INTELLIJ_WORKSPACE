...
public class SocketNode implements Runnable {
   ...
   static {
      logger = Logger.getLogger(class$org$apache$log4j$net$SocketNode == null ? (class$org$apache$log4j$net$SocketNode = class$("org.apache.log4j.net.SocketNode")) : class$org$apache$log4j$net$SocketNode);
   }
}
