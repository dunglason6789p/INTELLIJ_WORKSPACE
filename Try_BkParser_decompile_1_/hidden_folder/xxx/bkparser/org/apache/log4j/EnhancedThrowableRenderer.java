...
public final class EnhancedThrowableRenderer implements ThrowableRenderer {
   ...
   public EnhancedThrowableRenderer() {
      try {
         Class[] noArgs = null;
         this.getStackTraceMethod = (class$java$lang$Throwable == null ? (class$java$lang$Throwable = class$("java.lang.Throwable")) : class$java$lang$Throwable).getMethod("getStackTrace", (Class[])noArgs);
