...
public class PropertyConfigurator implements Configurator {
   ...
   protected void configureLoggerFactory(Properties props) {
      ...
      if (factoryClassName != null) {
         ...
         this.loggerFactory = (LoggerFactory)OptionConverter.instantiateByClassName(factoryClassName, class$org$apache$log4j$spi$LoggerFactory == null ? (class$org$apache$log4j$spi$LoggerFactory = class$("org.apache.log4j.spi.LoggerFactory")) : class$org$apache$log4j$spi$LoggerFactory, this.loggerFactory);
         ...
         while(enumeration.hasMoreElements()) {
            ...
            if (!key.startsWith("log4j.category.") && !key.startsWith("log4j.logger.")) {
               if (key.startsWith("log4j.renderer.")) {
                  ...
                  ThrowableRenderer tr = (ThrowableRenderer)OptionConverter.instantiateByKey(props, "log4j.throwableRenderer", class$org$apache$log4j$spi$ThrowableRenderer == null ? (class$org$apache$log4j$spi$ThrowableRenderer = class$("org.apache.log4j.spi.ThrowableRenderer")) : class$org$apache$log4j$spi$ThrowableRenderer, (Object)null);
                  if (tr == null) {
   ...
   Appender parseAppender(Properties props, String appenderName) {
      ...
      if (appender != null) {
         ...
         appender = (Appender)OptionConverter.instantiateByKey(props, prefix, class$org$apache$log4j$Appender == null ? (class$org$apache$log4j$Appender = class$("org.apache.log4j.Appender")) : class$org$apache$log4j$Appender, (Object)null);
         if (appender == null) {
            ...
            if (appender instanceof OptionHandler) {
               if (appender.requiresLayout()) {
                  Layout layout = (Layout)OptionConverter.instantiateByKey(props, layoutPrefix, class$org$apache$log4j$Layout == null ? (class$org$apache$log4j$Layout = class$("org.apache.log4j.Layout")) : class$org$apache$log4j$Layout, (Object)null);
                  if (layout != null) {
               ...
               if (errorHandlerClass != null) {
                  ErrorHandler eh = (ErrorHandler)OptionConverter.instantiateByKey(props, errorHandlerPrefix, class$org$apache$log4j$spi$ErrorHandler == null ? (class$org$apache$log4j$spi$ErrorHandler = class$("org.apache.log4j.spi.ErrorHandler")) : class$org$apache$log4j$spi$ErrorHandler, (Object)null);
                  if (eh != null) {
         ...
         do {
            while(g.hasMoreElements()) {
               ...
               if (filterKey != null) {
                  ...
                  filter = (Filter)OptionConverter.instantiateByClassName(filterKey, class$org$apache$log4j$spi$Filter == null ? (class$org$apache$log4j$spi$Filter = class$("org.apache.log4j.spi.Filter")) : class$org$apache$log4j$spi$Filter, (Object)null);
                  continue label46;
               }
