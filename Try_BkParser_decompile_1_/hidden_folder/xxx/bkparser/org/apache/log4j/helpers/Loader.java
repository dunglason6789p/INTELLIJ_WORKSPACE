...
public class Loader {
   ...
   public static URL getResource(String resource) {
      ...
      try {
         ...
         classLoader = (class$org$apache$log4j$helpers$Loader == null ? (class$org$apache$log4j$helpers$Loader = class$("org.apache.log4j.helpers.Loader")) : class$org$apache$log4j$helpers$Loader).getClassLoader();
         if (classLoader != null) {
   ...
   private static ClassLoader getTCL() throws IllegalAccessException, InvocationTargetException {
      ...
      try {
         method = (class$java$lang$Thread == null ? (class$java$lang$Thread = class$("java.lang.Thread")) : class$java$lang$Thread).getMethod("getContextClassLoader", (Class[])null);
