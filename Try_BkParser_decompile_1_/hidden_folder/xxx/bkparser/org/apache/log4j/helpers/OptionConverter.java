...
public class OptionConverter {
         ...
         if (hashIndex == -1) {
            ...
            if ("NULL".equalsIgnoreCase(levelName)) {
               ...
               try {
                  ...
                  Class[] paramTypes = new Class[]{class$java$lang$String == null ? (class$java$lang$String = class$("java.lang.String")) : class$java$lang$String, class$org$apache$log4j$Level == null ? (class$org$apache$log4j$Level = class$("org.apache.log4j.Level")) : class$org$apache$log4j$Level};
   ...
   public static void selectAndConfigure(URL url, String clazz, LoggerRepository hierarchy) {
      ...
      if (clazz != null) {
         ...
         configurator = (Configurator)instantiateByClassName(clazz, class$org$apache$log4j$spi$Configurator == null ? (class$org$apache$log4j$spi$Configurator = class$("org.apache.log4j.spi.Configurator")) : class$org$apache$log4j$spi$Configurator, (Object)null);
