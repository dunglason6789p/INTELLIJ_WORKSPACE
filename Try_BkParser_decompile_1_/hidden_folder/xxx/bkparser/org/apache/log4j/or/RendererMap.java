...
public class RendererMap {
   ...
   public static void addRenderer(RendererSupport repository, String renderedClassName, String renderingClassName) {
      ...
      ObjectRenderer renderer = (ObjectRenderer)OptionConverter.instantiateByClassName(renderingClassName, class$org$apache$log4j$or$ObjectRenderer == null ? (class$org$apache$log4j$or$ObjectRenderer = class$("org.apache.log4j.or.ObjectRenderer")) : class$org$apache$log4j$or$ObjectRenderer, (Object)null);
      if (renderer == null) {
