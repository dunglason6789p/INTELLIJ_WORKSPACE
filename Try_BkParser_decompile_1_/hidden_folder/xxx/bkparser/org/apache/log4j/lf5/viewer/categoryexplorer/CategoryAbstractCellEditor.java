...
public class CategoryAbstractCellEditor implements TableCellEditor, TreeCellEditor {
   ...
   public void addCellEditorListener(CellEditorListener l) {
      this._listenerList.add(class$javax$swing$event$CellEditorListener == null ? (class$javax$swing$event$CellEditorListener = class$("javax.swing.event.CellEditorListener")) : class$javax$swing$event$CellEditorListener, l);
   }

   public void removeCellEditorListener(CellEditorListener l) {
      this._listenerList.remove(class$javax$swing$event$CellEditorListener == null ? (class$javax$swing$event$CellEditorListener = class$("javax.swing.event.CellEditorListener")) : class$javax$swing$event$CellEditorListener, l);
   }
   ...
   protected void fireEditingStopped() {
      ...
      for(int i = listeners.length - 2; i >= 0; i -= 2) {
         if (listeners[i] == (class$javax$swing$event$CellEditorListener == null ? (class$javax$swing$event$CellEditorListener = class$("javax.swing.event.CellEditorListener")) : class$javax$swing$event$CellEditorListener)) {
