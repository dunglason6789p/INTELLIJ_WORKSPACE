...
public class LayoutDynamicMBean extends AbstractDynamicMBean {
      ...
      for(int i = 0; i < size; ++i) {
         ...
         if (readMethod != null) {
            ...
            if (this.isSupportedType(returnClass)) {
               ...
               if (returnClass.isAssignableFrom(class$org$apache$log4j$Level == null ? (class$org$apache$log4j$Level = class$("org.apache.log4j.Level")) : class$org$apache$log4j$Level)) {
   ...
   private boolean isSupportedType(Class clazz) {
      if (clazz.isPrimitive()) {
         ...
         return clazz.isAssignableFrom(class$org$apache$log4j$Level == null ? (class$org$apache$log4j$Level = class$("org.apache.log4j.Level")) : class$org$apache$log4j$Level);
      }
   }
   ...
   static {
      cat = Logger.getLogger(class$org$apache$log4j$jmx$LayoutDynamicMBean == null ? (class$org$apache$log4j$jmx$LayoutDynamicMBean = class$("org.apache.log4j.jmx.LayoutDynamicMBean")) : class$org$apache$log4j$jmx$LayoutDynamicMBean);
   }
}
