...
public class Agent {
   ...
   static {
      log = Logger.getLogger(class$org$apache$log4j$jmx$Agent == null ? (class$org$apache$log4j$jmx$Agent = class$("org.apache.log4j.jmx.Agent")) : class$org$apache$log4j$jmx$Agent);
   }
}
