...
public class HierarchyDynamicMBean extends AbstractDynamicMBean implements HierarchyEventListener, NotificationBroadcaster {
   ...
   static {
      log = Logger.getLogger(class$org$apache$log4j$jmx$HierarchyDynamicMBean == null ? (class$org$apache$log4j$jmx$HierarchyDynamicMBean = class$("org.apache.log4j.jmx.HierarchyDynamicMBean")) : class$org$apache$log4j$jmx$HierarchyDynamicMBean);
   }
}
