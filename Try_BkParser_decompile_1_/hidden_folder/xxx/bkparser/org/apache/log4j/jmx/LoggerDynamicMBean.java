...
public class LoggerDynamicMBean extends AbstractDynamicMBean implements NotificationListener {
   ...
   void addAppender(String appenderClass, String appenderName) {
      ...
      Appender appender = (Appender)OptionConverter.instantiateByClassName(appenderClass, class$org$apache$log4j$Appender == null ? (class$org$apache$log4j$Appender = class$("org.apache.log4j.Appender")) : class$org$apache$log4j$Appender, (Object)null);
   ...
   static {
      cat = Logger.getLogger(class$org$apache$log4j$jmx$LoggerDynamicMBean == null ? (class$org$apache$log4j$jmx$LoggerDynamicMBean = class$("org.apache.log4j.jmx.LoggerDynamicMBean")) : class$org$apache$log4j$jmx$LoggerDynamicMBean);
   }
}
