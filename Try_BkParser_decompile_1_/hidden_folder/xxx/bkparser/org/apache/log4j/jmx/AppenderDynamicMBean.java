...
public class AppenderDynamicMBean extends AbstractDynamicMBean {
      ...
      for(int i = 0; i < size; ++i) {
         ...
         if (readMethod != null) {
            ...
            if (this.isSupportedType(returnClass)) {
               ...
               if (returnClass.isAssignableFrom(class$org$apache$log4j$Priority == null ? (class$org$apache$log4j$Priority = class$("org.apache.log4j.Priority")) : class$org$apache$log4j$Priority)) {
   ...
   private boolean isSupportedType(Class clazz) {
      if (clazz.isPrimitive()) {
         return true;
      } else if (clazz == (class$java$lang$String == null ? (class$java$lang$String = class$("java.lang.String")) : class$java$lang$String)) {
         return true;
      } else {
         return clazz.isAssignableFrom(class$org$apache$log4j$Priority == null ? (class$org$apache$log4j$Priority = class$("org.apache.log4j.Priority")) : class$org$apache$log4j$Priority);
      }
   }
   ...
   public Object invoke(String operationName, Object[] params, String[] signature) throws MBeanException, ReflectionException {
      if (operationName.equals("activateOptions") && this.appender instanceof OptionHandler) {
         ...
         if (operationName.equals("setLayout")) {
            Layout layout = (Layout)OptionConverter.instantiateByClassName((String)params[0], class$org$apache$log4j$Layout == null ? (class$org$apache$log4j$Layout = class$("org.apache.log4j.Layout")) : class$org$apache$log4j$Layout, (Object)null);
      ...
      if (attribute == null) {
         ...
         if (name == null) {
            ...
            if (mu != null && mu.writeMethod != null) {
               ...
               if (params[0] == (class$org$apache$log4j$Priority == null ? (class$org$apache$log4j$Priority = class$("org.apache.log4j.Priority")) : class$org$apache$log4j$Priority)) {
   ...
   static {
      cat = Logger.getLogger(class$org$apache$log4j$jmx$AppenderDynamicMBean == null ? (class$org$apache$log4j$jmx$AppenderDynamicMBean = class$("org.apache.log4j.jmx.AppenderDynamicMBean")) : class$org$apache$log4j$jmx$AppenderDynamicMBean);
   }
}
