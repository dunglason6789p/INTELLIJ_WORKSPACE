...
public class PropertySetter {
   ...
   public void setProperties(Properties properties, String prefix) {
      ...
      while(true) {
         while(true) {
            ...
            if (prop != null && (class$org$apache$log4j$spi$OptionHandler == null ? (class$org$apache$log4j$spi$OptionHandler = class$("org.apache.log4j.spi.OptionHandler")) : class$org$apache$log4j$spi$OptionHandler).isAssignableFrom(prop.getPropertyType()) && prop.getWriteMethod() != null) {
   ...
   protected Object convertArg(String val, Class type) {
      if (val == null) {
         ...
         String v = val.trim();
         if ((class$java$lang$String == null ? (class$java$lang$String = class$("java.lang.String")) : class$java$lang$String).isAssignableFrom(type)) {
            return val;
            ...
            if (Boolean.TYPE.isAssignableFrom(type)) {
               ...
               if ((class$org$apache$log4j$Priority == null ? (class$org$apache$log4j$Priority = class$("org.apache.log4j.Priority")) : class$org$apache$log4j$Priority).isAssignableFrom(type)) {
                  return OptionConverter.toLevel(v, Level.DEBUG);
               }

               if ((class$org$apache$log4j$spi$ErrorHandler == null ? (class$org$apache$log4j$spi$ErrorHandler = class$("org.apache.log4j.spi.ErrorHandler")) : class$org$apache$log4j$spi$ErrorHandler).isAssignableFrom(type)) {
                  return OptionConverter.instantiateByClassName(v, class$org$apache$log4j$spi$ErrorHandler == null ? (class$org$apache$log4j$spi$ErrorHandler = class$("org.apache.log4j.spi.ErrorHandler")) : class$org$apache$log4j$spi$ErrorHandler, (Object)null);
               }
            }
