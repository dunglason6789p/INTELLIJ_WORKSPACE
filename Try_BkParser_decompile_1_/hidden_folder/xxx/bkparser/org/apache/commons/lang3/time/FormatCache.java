...
abstract class FormatCache<F extends Format> {
   ...
   private final ConcurrentMap<FormatCache.MultipartKey, String> cDateTimeInstanceCache = new ConcurrentHashMap(7);
   ...
   private static class MultipartKey {
      ...
      public boolean equals(Object obj) {
         if (this == obj) {
            ...
            return !(obj instanceof FormatCache.MultipartKey) ? false : Arrays.equals(this.keys, ((FormatCache.MultipartKey)obj).keys);
         }
      }
