...
public final class PlanarAddressFunction extends AddressFunction {
   ...
   private final PlanarAddressFunction.PlanarSubFunction subFunction;
   ...
   public PlanarAddressFunction(String _subFunctionName, AlgoritmInterface _parsingAlgorithm) {
      ...
      this.subFunction = PlanarAddressFunction.PlanarSubFunction.valueOf(this.subFunctionName.toUpperCase());
   ...
   private void update(PlanarConfig config) throws MaltChainedException {
      if (this.subFunction == PlanarAddressFunction.PlanarSubFunction.STACK) {
         this.address.setAddress(config.getStackNode(this.index));
      } else if (this.subFunction == PlanarAddressFunction.PlanarSubFunction.INPUT) {
