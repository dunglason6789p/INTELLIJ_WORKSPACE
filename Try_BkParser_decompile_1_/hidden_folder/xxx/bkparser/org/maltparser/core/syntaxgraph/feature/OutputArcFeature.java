...
public final class OutputArcFeature implements FeatureFunction {
   ...
   public void update() throws MaltChainedException {
      ...
      try {
         if (arg1.getAddress() != null && arg2.getAddress() != null) {
            ...
            int head2 = -1;
            if (node1.hasHead()) {
               head1 = node1.getHead().getIndex();
            }

            if (node2.hasHead()) {
               head2 = node2.getHead().getIndex();
            }
         ...
         throw new FeatureException("The index of the feature must be an integer value. ", var7);
      }
   ...
   public String toString() {
      return "OutputArc(" + this.column.getName() + ")";
   }
}
