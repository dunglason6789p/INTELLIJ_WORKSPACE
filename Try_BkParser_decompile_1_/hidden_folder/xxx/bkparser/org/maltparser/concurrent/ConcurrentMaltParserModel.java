...
public final class ConcurrentMaltParserModel {
   ...
   protected ConcurrentMaltParserModel(int _optionContainer, URL _mcoURL) throws MaltChainedException {
      ...
      try {
         ...
         throw new MaltChainedException("Couldn't read file " + inputFormatName + " from mco-file ", var8);
      }
      ...
      try {
         ...
         throw new MaltChainedException("Couldn't read file symboltables.sym from mco-file ", var7);
      }
      ...
      this.singleMalt = new LWSingleMalt(this.optionContainer, this.dataFormatInstance, this.mcoModel, (PropagationManager)null, featureModelManager);
   ...
   private FeatureModelManager loadFeatureModelManager(int optionContainer, McoModel mcoModel) throws MaltChainedException {
      ...
      try {
         ...
         throw new MaltChainedException("Couldn't read file " + featureModelFileName + " from mco-file ", var8);
      }
   }
}
