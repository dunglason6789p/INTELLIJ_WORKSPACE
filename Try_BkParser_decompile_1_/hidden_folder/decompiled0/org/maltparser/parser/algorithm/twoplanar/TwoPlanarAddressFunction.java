...
public final class TwoPlanarAddressFunction
extends AddressFunction {
    ...
    public TwoPlanarAddressFunction(String _subFunctionName, AlgoritmInterface _parsingAlgorithm) {
        ...
        this.subFunction = TwoPlanarSubFunction.valueOf(this.subFunctionName.toUpperCase());
    ...
    private void update(TwoPlanarConfig config) throws MaltChainedException {
        if (this.subFunction == TwoPlanarSubFunction.ACTIVESTACK) {
            this.address.setAddress(config.getActiveStackNode(this.index));
        } else if (this.subFunction == TwoPlanarSubFunction.INACTIVESTACK) {
            this.address.setAddress(config.getInactiveStackNode(this.index));
        } else if (this.subFunction == TwoPlanarSubFunction.INPUT) {
