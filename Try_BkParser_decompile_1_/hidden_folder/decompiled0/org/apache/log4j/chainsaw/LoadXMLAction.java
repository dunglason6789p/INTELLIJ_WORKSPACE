...
extends AbstractAction {
    private static final Logger LOG = Logger.getLogger(class$org$apache$log4j$chainsaw$LoadXMLAction == null ? (class$org$apache$log4j$chainsaw$LoadXMLAction = LoadXMLAction.class$("org.apache.log4j.chainsaw.LoadXMLAction")) : class$org$apache$log4j$chainsaw$LoadXMLAction);
