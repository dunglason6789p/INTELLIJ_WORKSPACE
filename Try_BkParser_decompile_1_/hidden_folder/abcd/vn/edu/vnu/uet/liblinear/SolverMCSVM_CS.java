...
import vn.edu.vnu.uet.liblinear.ArraySorter;
import vn.edu.vnu.uet.liblinear.DoubleArrayPointer;
            ...
            for (int s = 0; s < active_size; ++s) {
                ...
                for (Feature xi : this.prob.x[i]) {
                    ...
                    for (m = 0; m < active_size_i[i]; ++m) {
                        double[] arrd = this.G;
                        int n = m;
                        arrd[n] = arrd[n] + w[w_offset + alpha_index_i.get(m)] * xi.getValue();
                    }
                }
                ...
                for (Feature xi : this.prob.x[i]) {
                    ...
                    for (m = 0; m < nz_d; ++m) {
                        ...
                        arrd[n] = arrd[n] + d_val[m] * xi.getValue();
                    }
                }
            }
            if (++iter % 10 == 0) {
