...
public final class NivreAddressFunction
extends AddressFunction {
    ...
    public NivreAddressFunction(String _subFunctionName, AlgoritmInterface _parsingAlgorithm) {
        ...
        this.subFunction = NivreSubFunction.valueOf(this.subFunctionName.toUpperCase());
    ...
    public void update(Object[] arguments) throws MaltChainedException {
        if (this.subFunction == NivreSubFunction.STACK) {
            this.address.setAddress(((NivreConfig)arguments[0]).getStackNode(this.index));
        } else if (this.subFunction == NivreSubFunction.INPUT) {
