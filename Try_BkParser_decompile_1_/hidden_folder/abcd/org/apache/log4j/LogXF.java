...
public abstract class LogXF {
    ...
    private static final String FQCN = (class$org$apache$log4j$LogXF == null ? (class$org$apache$log4j$LogXF = LogXF.class$("org.apache.log4j.LogXF")) : class$org$apache$log4j$LogXF).getName();
