            ...
            case 'd': {
                ...
                if (dateFormatStr.equalsIgnoreCase("ISO8601")) {
                    ...
                    try {
                        ...
                        df = (DateFormat)OptionConverter.instantiateByClassName("org.apache.log4j.helpers.ISO8601DateFormat", class$java$text$DateFormat == null ? (class$java$text$DateFormat = PatternParser.class$("java.text.DateFormat")) : class$java$text$DateFormat, null);
                    }
                }
