    ...
    public void activateOptions() {
        try {
            ...
            if (this.initialContextFactoryName != null) {
                ...
                ((Hashtable)env).put("java.naming.factory.initial", this.initialContextFactoryName);
                if (this.providerURL != null) {
                    ((Hashtable)env).put("java.naming.provider.url", this.providerURL);
                } else {
                ...
                if (this.urlPkgPrefixes != null) {
                    ((Hashtable)env).put("java.naming.factory.url.pkgs", this.urlPkgPrefixes);
                }
                if (this.securityPrincipalName != null) {
                    ((Hashtable)env).put("java.naming.security.principal", this.securityPrincipalName);
                    if (this.securityCredentials != null) {
                        ((Hashtable)env).put("java.naming.security.credentials", this.securityCredentials);
                    } else {
