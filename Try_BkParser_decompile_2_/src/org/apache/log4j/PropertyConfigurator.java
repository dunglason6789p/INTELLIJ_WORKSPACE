...
implements Configurator {
    ...
    Appender parseAppender(Properties props, String appenderName) {
        ...
        if (appender instanceof OptionHandler) {
            ...
            if ((errorHandlerClass = OptionConverter.findAndSubst(errorHandlerPrefix = prefix + ".errorhandler", props)) != null && (eh = (ErrorHandler)OptionConverter.instantiateByKey(props, errorHandlerPrefix, class$org$apache$log4j$spi$ErrorHandler == null ? (class$org$apache$log4j$spi$ErrorHandler = PropertyConfigurator.class$("org.apache.log4j.spi.ErrorHandler")) : class$org$apache$log4j$spi$ErrorHandler, null)) != null) {
                ...
                while (iter.hasNext()) {
                    ...
                    ((Hashtable)edited).put(entry.getKey(), entry.getValue());
                }
